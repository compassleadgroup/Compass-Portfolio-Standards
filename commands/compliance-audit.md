...
4. Missing header disclosure strip, footer disclaimer, or TCPA consent block on any page. Check that the copy matches the exact templates in the Required Page Elements section of COMPLIANCE_STANDARDS.md.
