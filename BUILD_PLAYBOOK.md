...
3. **Check required flags and select defaults, not just the field count.** One live site had phone optional while email was required. Under the six-field ask both are required, so the defect to look for now is either one silently optional.
